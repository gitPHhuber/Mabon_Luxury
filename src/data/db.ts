...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 'p2',
    name: 'ФИЛИН Зеркало ночного неба №2',
    description: 'Сидит молчаливо, но в его взгляде — вся глубина зимней тьмы. Он видит то, что скрыто: путь снежинок, движения теней, дыхание леса под звёздами. Его фарфоровые перья отражают свет луны, превращая тьму в холодное серебро.',
    price: 29000,
  ...
  {
    id: 'p3',
    name: 'РЫСЬ Тень снега, шаг звезды №3',
    description: 'Она движется неслышно, будто сама часть зимнего леса. Её уши ловят дыхание ветра, а взгляд — холоден и точен, как кромка льда. Рысь не нападает и не прячется — она наблюдает, растворяясь между стволами, где свет луны превращает снег в серебро. Фарфор передаёт её пластичность: мгновение перед прыжком, покой перед вихрем. Она — воплощённая грация северной ночи.',
    price: 32000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-20-46.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-20-46.jpg'],
    authorId: '3',
    collection: 'Фарфор',
    isFeatured: true,
  },
  {
    id: 'p4',
    name: 'МЕДВЕДЬ Тишина спящей тайги №4',
    description: 'Он неподвижен, но в этой неподвижности — мощь земли и дыхание веков. Белизна фарфора превращает его силу в безмолвие покоя, в котором слышно, как растёт лёд на реках. Он не спит — он просто ждёт весну.',
    price: 35000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-20-52.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-20-52.jpg'],
    authorId: '4',
    collection: 'Фарфор',
    isFeatured: true,
  },
  {
    id: 'p5',
    name: 'СНЕГУРОЧКА Дочь инея и северного света №5',
    description: 'Она рождается там, где первый снег встречает рассвет. Лёгкое движение руки — и воздух наполняется кристаллами света. В её облике — чистота утреннего холода, прозрачная нежность и хрупкое чудо, что тает на ладони.',
    price: 38000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-20-59.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-20-59.jpg'],
    authorId: '5',
    collection: 'Фарфор'
  },
  {
    id: 'p6',
    name: 'ДЕД МОРОЗ Властелин зимнего царства №6',
    description: 'Когда лес укрыт серебром, а дыхание ветра звенит, он выходит из тишины. Его посох соединяет небо и землю, борода — словно инеем покрытые ели, взгляд — глубже январской ночи. Он несёт с собой покой, силу и вечное дыхание зимы, застывшее в фарфоре.',
    price: 41000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-20-54.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-20-54.jpg'],
    authorId: '1',
    collection: 'Фарфор'
  },
  {
  ...
  {
    id: 'p15',
    name: 'ЗАЯЦ Тень рассвета №15',
    description: 'Мал, но внимателен — его уши ловят дыхание ветра, готового сменить ночь на утро. Он замирает, чтобы стать частью пейзажа, сотканного из тишины. Кажется, вот-вот дрогнет — и снег оживёт вместе с ним.',
    price: 68000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-20-57.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-20-57.jpg'],
    authorId: '5',
    collection: 'Фарфор',
    isFeatured: true,
  },
  ...
  {
    id: 'p23',
    name: 'ЛИСА Огненная нить среди снегов',
    description: 'Мгновение — и она растворяется между сугробов, оставив лишь лёгкий след. Её хвост — вспышка заката, её взгляд — тёплый отблеск жизни в холодной сказке. Она — хитрость и грация, оживший отблеск зимнего солнца.',
    price: 92000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-21-03.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-21-03.jpg'],
    authorId: '3',
  ...
  {
    id: 'p26',
    name: 'ВОЛК Песнь метели',
    description: 'Его голос разрывает ледяную тишину и уходит в звёздное небо. В каждой грани — отблеск лунного света, в каждом изгибе — стремительность ветра. Он — зов свободы, вечный странник зимних просторов.',
    price: 101000,
    imageUrl: '/images/full/img/photo_2025-10-22_10-21-01.jpg',
    gallery: ['/images/full/img/photo_2025-10-22_10-21-01.jpg'],
    authorId: '1',
    collection: 'Фарфор',
    isFeatured: true,
  },
