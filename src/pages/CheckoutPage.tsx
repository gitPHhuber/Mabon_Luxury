...
export const CheckoutPage = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (paymentMethod === 'sbp') {
            ...
            }, 5000); // Simulate SBP payment confirmation
        } else {
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" placeholder="ФИО" required value={formData.name} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded focus:ring-brown-gray focus:border-brown-gray text-brown-gray placeholder-brown-gray/70"/>
                            </div>
                             <div>
                                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                <input type="email" name="email" id="email" placeholder="Email" required value={formData.email} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded focus:ring-brown-gray focus:border-brown-gray text-brown-gray placeholder-brown-gray/70"/>
                            </div>
                            <div>
                                <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-1">Телефон</label>
                                <input type="tel" name="phone" id="phone" placeholder="Телефон" required onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded focus:ring-brown-gray focus:border-brown-gray text-brown-gray placeholder-brown-gray/70"/>
                            </div>
                        </div>
                    </div>
                    <div className="mt-10">
                        ...
                        <input type="text" name="address" id="address" placeholder="Адрес доставки" required onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded focus:ring-brown-gray focus:border-brown-gray text-brown-gray placeholder-brown-gray/70"/>
                    </div>
                     <div className="mt-10">
